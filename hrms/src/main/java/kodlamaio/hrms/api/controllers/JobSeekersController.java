...
public class JobSeekersController {
	...
	public ResponseEntity<Result> register(@Valid @RequestBody final JobSeekerRegisterDto jobSeekerRegisterDto) {
		final Result result = jobSeekerService.register(jobSeekerRegisterDto);
