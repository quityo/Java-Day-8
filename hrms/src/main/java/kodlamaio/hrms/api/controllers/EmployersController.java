...
public class EmployersController {
	...
	public ResponseEntity<Result> register(@Valid @RequestBody final EmployerRegisterDto employerRegisterDto) {
		final Result result = employerService.register(employerRegisterDto);
