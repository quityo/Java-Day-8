...
public class JobAdvertManager implements JobAdvertService {
	...
	@Override
	public DataResult<List<JobAdvertListDto>> getAllByIsActiveAndEmployer_CompanyNameForList(final boolean isActive,
			final String companyName) {
		final List<JobAdvertListDto> jobAdvertListDtos = jobAdvertDao
				.findAllByIsActiveAndEmployer_CompanyNameForList(isActive, companyName);

		return new SuccessDataResult<List<JobAdvertListDto>>(jobAdvertListDtos);
	}

	@Override
	public DataResult<List<JobAdvertListDto>> getAllByIsActiveForList(final boolean isActive) {
		final List<JobAdvertListDto> jobAdvertListDtos = jobAdvertDao.findAllByIsActiveForList(isActive);

		return new SuccessDataResult<List<JobAdvertListDto>>(jobAdvertListDtos);
	}

	@Override
	public DataResult<List<JobAdvertListDto>> getAllByIsActiveOrderByCreatedAtByForList(final boolean isActive,
			final String direction) {
		final List<JobAdvertListDto> jobAdvertListDtos = direction.equals("desc")
